...
class Application {
  ...
  help() {
    ...
    console.log('-l, --link <link...>', 'List of service paths that should be launched from local codebases.')
    ...
    return registry.visitServices(servicesToVisit, (microservice) => {
      return co(function* visitServiceImpl() {
        ...
        for (let i = 0; i != setupSteps.length; ++i) {
          ...
          yield passthruPromise(microservice.setup[i], { cwd: microservice.path })
        }
      })
    })
  }
